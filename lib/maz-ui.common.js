...
var utils_isCountryAvailable = function isCountryAvailable(locale) {
...
var fetchCountryCode = /*#__PURE__*/function () {
  var _ref = utils_asyncToGenerator( /*#__PURE__*/regenerator_default.a.mark(function _callee() {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 6:
            ...
            return _context.abrupt("return", result.substr(2, 2));
          ...
          case 12:
            ...
            return _context.abrupt("return", new Error('[MazPhoneNumberInput] Error while fetching country code'));
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                countryAvailable = utils_isCountryAvailable(locale);
    ...
    [
      _c(
        ...
        _vm._b(
          {
            ref: "textField",
            attrs: { color: _vm.color, loading: _vm.loading },
            on: {
...
/* harmony default export */ var MazSearch_mainvue_type_script_lang_js_ = ({
  ...
  computed: {
    ...
    selectedValueIndex: function selectedValueIndex() {
      ...
      return this.value ? this.items.findIndex(function (c) {
        return (itemValue ? c[itemValue] : c) === _this2.value;
      }) : null;
    },
  ...
  methods: {
    ...
    updateValue: function updateValue(item) {
      ...
      var valueReturned = itemValue ? item[itemValue] : item; // event sent when user select an item in the items list
...
/* harmony default export */ var MazSlider_mainvue_type_script_lang_js_ = ({
  ...
  methods: {
        ...
        return regenerator_default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return _this.checkValues(emitValue);
    ...
    checkValues: function checkValues(emitValue) {
      var _this2 = this;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                if (emitValue) _this2.emitValue(valuesChecked);
